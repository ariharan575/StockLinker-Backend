...
import com.backend.StockLinker.Exception.customExceptions.InvalidTokenException;
import com.backend.StockLinker.Exception.customExceptions.TokenExpiredException;
...
import com.backend.StockLinker.Auth_Service.repository.RefreshTokenRepository;
...
public class RefreshTokenService {
    ...
    public RefreshToken create(User user, String deviceId) {
        ...
        if (user == null || user.getId() == null) {
            throw new BadRequestException("User is required for token creation");
        }

        if (deviceId == null || deviceId.isBlank()) {
            throw new BadRequestException("Device ID is required for token creation");
        }
