...
public abstract class ConversationMapper {
    ...
    @Mapping(target = "counterpartRole", expression = "java(isBuyer(conversation, viewerUserId) ? com.backend.StockLinker.Message_Service.enums.UserRole.SELLER : com.backend.StockLinker.Message_Service.enums.UserRole.BUYER)")
    @Mapping(target = "myRole", expression = "java(isBuyer(conversation, viewerUserId) ? com.backend.StockLinker.Message_Service.enums.UserRole.BUYER : com.backend.StockLinker.Message_Service.enums.UserRole.SELLER)")
