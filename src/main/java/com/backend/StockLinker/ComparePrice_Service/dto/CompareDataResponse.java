...
public class CompareDataResponse {
    ...
    private MarketBoundaries marketBoundaries;
    ...
    @NoArgsConstructor
    @AllArgsConstructor
    public static class MarketBoundaries {
    ...
    public static class SupplierRow {
        ...
        private BigDecimal priceDifferenceFromAverage;
        private BigDecimal percentageDifference;
        private boolean isCheaperThanAverage;
