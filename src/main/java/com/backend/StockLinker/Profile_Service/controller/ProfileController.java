...
public class ProfileController {
    ...
    @PutMapping("/store")
    public ResponseEntity<ApiResponse<String>> updateStore(@RequestBody StoreUpdateRequest request, Principal principal) {
        profileService.updateStore(getUserId(principal), request);
        return ResponseEntity.ok(ApiResponse.success("Store address updated successfully", null));
    }

    @PutMapping("/delivery-insights")
    public ResponseEntity<ApiResponse<String>> updateDeliveryAndInsights(@RequestBody DeliveryInsightsUpdateRequest request, Principal principal) {
        profileService.updateDeliveryAndInsights(getUserId(principal), request);
